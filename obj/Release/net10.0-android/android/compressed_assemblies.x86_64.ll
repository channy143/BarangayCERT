...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [177 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 19609672; uint32_t buffer_offset
	}, ; 174: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 19780680; uint32_t buffer_offset
	}, ; 175: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2085888, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 19803240; uint32_t buffer_offset
	} ; 176: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 21889128, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [21889128 x i8] zeroinitializer, align 16
