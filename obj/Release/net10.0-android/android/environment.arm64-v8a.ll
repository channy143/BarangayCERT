...
@dso_apk_entries = dso_local local_unnamed_addr global [151 x %struct.DSOApkEntry] zeroinitializer, align 8
...
@.DSOCacheEntry.19_name = private unnamed_addr constant [62 x i8] c"libaot-Microsoft.Extensions.FileProviders.Abstractions.dll.so\00", align 1
@.DSOCacheEntry.20_name = private unnamed_addr constant [56 x i8] c"libaot-Microsoft.Extensions.Hosting.Abstractions.dll.so\00", align 1
...
@.DSOCacheEntry.25_name = private unnamed_addr constant [51 x i8] c"libaot-Microsoft.IdentityModel.Abstractions.dll.so\00", align 1
@.DSOCacheEntry.26_name = private unnamed_addr constant [52 x i8] c"libaot-Microsoft.IdentityModel.JsonWebTokens.dll.so\00", align 1
@.DSOCacheEntry.27_name = private unnamed_addr constant [46 x i8] c"libaot-Microsoft.IdentityModel.Logging.dll.so\00", align 1
@.DSOCacheEntry.28_name = private unnamed_addr constant [45 x i8] c"libaot-Microsoft.IdentityModel.Tokens.dll.so\00", align 1
@.DSOCacheEntry.29_name = private unnamed_addr constant [50 x i8] c"libaot-Microsoft.IO.RecyclableMemoryStream.dll.so\00", align 1
...
@.DSOCacheEntry.35_name = private unnamed_addr constant [26 x i8] c"libaot-MimeMapping.dll.so\00", align 1
...
@.DSOCacheEntry.41_name = private unnamed_addr constant [23 x i8] c"libaot-Supabase.dll.so\00", align 1
@.DSOCacheEntry.42_name = private unnamed_addr constant [28 x i8] c"libaot-Supabase.Core.dll.so\00", align 1
@.DSOCacheEntry.43_name = private unnamed_addr constant [33 x i8] c"libaot-Supabase.Functions.dll.so\00", align 1
@.DSOCacheEntry.44_name = private unnamed_addr constant [30 x i8] c"libaot-Supabase.Gotrue.dll.so\00", align 1
@.DSOCacheEntry.45_name = private unnamed_addr constant [33 x i8] c"libaot-Supabase.Postgrest.dll.so\00", align 1
@.DSOCacheEntry.46_name = private unnamed_addr constant [32 x i8] c"libaot-Supabase.Realtime.dll.so\00", align 1
@.DSOCacheEntry.47_name = private unnamed_addr constant [31 x i8] c"libaot-Supabase.Storage.dll.so\00", align 1
@.DSOCacheEntry.48_name = private unnamed_addr constant [38 x i8] c"libaot-Syncfusion.Maui.Toolkit.dll.so\00", align 1
@.DSOCacheEntry.49_name = private unnamed_addr constant [48 x i8] c"libaot-Syncfusion.Maui.Toolkit.resources.dll.so\00", align 1
@.DSOCacheEntry.50_name = private unnamed_addr constant [46 x i8] c"libaot-System.IdentityModel.Tokens.Jwt.dll.so\00", align 1
@.DSOCacheEntry.51_name = private unnamed_addr constant [30 x i8] c"libaot-System.Reactive.dll.so\00", align 1
@.DSOCacheEntry.52_name = private unnamed_addr constant [31 x i8] c"libaot-Websocket.Client.dll.so\00", align 1
...
@.DSOCacheEntry.67_name = private unnamed_addr constant [69 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.ViewModelSavedState.Android.dll.so\00", align 1
@.DSOCacheEntry.68_name = private unnamed_addr constant [38 x i8] c"libaot-Xamarin.AndroidX.Loader.dll.so\00", align 1
@.DSOCacheEntry.69_name = private unnamed_addr constant [57 x i8] c"libaot-Xamarin.AndroidX.Navigation.Common.Android.dll.so\00", align 1
...
@.DSOCacheEntry.71_name = private unnamed_addr constant [58 x i8] c"libaot-Xamarin.AndroidX.Navigation.Runtime.Android.dll.so\00", align 1
...
@.DSOCacheEntry.74_name = private unnamed_addr constant [61 x i8] c"libaot-Xamarin.AndroidX.SavedState.SavedState.Android.dll.so\00", align 1
...
@.DSOCacheEntry.105_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Http.dll.so\00", align 1
@.DSOCacheEntry.106_name = private unnamed_addr constant [40 x i8] c"libaot-System.Net.NameResolution.dll.so\00", align 1
@.DSOCacheEntry.107_name = private unnamed_addr constant [44 x i8] c"libaot-System.Net.NetworkInformation.dll.so\00", align 1
@.DSOCacheEntry.108_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Ping.dll.so\00", align 1
...
@.DSOCacheEntry.122_name = private unnamed_addr constant [49 x i8] c"libaot-System.Reflection.Emit.Lightweight.dll.so\00", align 1
@.DSOCacheEntry.123_name = private unnamed_addr constant [43 x i8] c"libaot-System.Reflection.Primitives.dll.so\00", align 1
@.DSOCacheEntry.124_name = private unnamed_addr constant [64 x i8] c"libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so\00", align 1
...
@.DSOCacheEntry.133_name = private unnamed_addr constant [46 x i8] c"libaot-System.Text.Encoding.Extensions.dll.so\00", align 1
@.DSOCacheEntry.134_name = private unnamed_addr constant [40 x i8] c"libaot-System.Text.Encodings.Web.dll.so\00", align 1
@.DSOCacheEntry.135_name = private unnamed_addr constant [31 x i8] c"libaot-System.Text.Json.dll.so\00", align 1
@.DSOCacheEntry.136_name = private unnamed_addr constant [45 x i8] c"libaot-System.Text.RegularExpressions.dll.so\00", align 1
@.DSOCacheEntry.137_name = private unnamed_addr constant [40 x i8] c"libaot-System.Threading.Channels.dll.so\00", align 1
@.DSOCacheEntry.138_name = private unnamed_addr constant [38 x i8] c"libaot-System.Threading.Thread.dll.so\00", align 1
@.DSOCacheEntry.139_name = private unnamed_addr constant [31 x i8] c"libaot-System.Threading.dll.so\00", align 1
@.DSOCacheEntry.140_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 1
@.DSOCacheEntry.141_name = private unnamed_addr constant [30 x i8] c"libaot-System.Xml.Linq.dll.so\00", align 1
@.DSOCacheEntry.142_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 1
@.DSOCacheEntry.143_name = private unnamed_addr constant [35 x i8] c"libaot-System.Xml.XDocument.dll.so\00", align 1
@.DSOCacheEntry.144_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 1
@.DSOCacheEntry.145_name = private unnamed_addr constant [23 x i8] c"libaot-mscorlib.dll.so\00", align 1
@.DSOCacheEntry.146_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 1
